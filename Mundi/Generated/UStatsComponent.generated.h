...
#define U_STATS_COMPONENT_BODY \
public: \
    using Super = UActorComponent; \
    using ThisClass_t = UStatsComponent; \
    static UClass* StaticClass() \
    { \
        static UClass Cls{ "UStatsComponent", UActorComponent::StaticClass(), sizeof(UStatsComponent) }; \
        static bool bRegistered = (UClass::SignUpClass(&Cls), true); \
        return &Cls; \
    } \
    virtual UClass* GetClass() const override { return UStatsComponent::StaticClass(); } \
    UStatsComponent(const UStatsComponent&) = default; \
    UStatsComponent* Duplicate() const override \
    { \
        UStatsComponent* NewObject = ObjectFactory::DuplicateObject<UStatsComponent>(this); \
...
#define CURRENT_CLASS_GENERATED_BODY U_STATS_COMPONENT_BODY
